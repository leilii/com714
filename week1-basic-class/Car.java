    ...
    //Task 1.3 - Setter Methods
     ...
     //Task 1.4 - Methods
       ...
       public void accelerate(int speedamount){
           this.currentSpeed=this.currentSpeed + speedamount;
           this.fuelLevel=this.fuelLevel- speedamount;
       } 
       public void brake(int brakeAmount){
          if (this.currentSpeed - brakeAmount>0) 
           this.currentSpeed=this.currentSpeed-brakeAmount;
          else this.currentSpeed=0.0; 
       }
       public void refuel(int fuelAmount){
          private double capacity;
          capacity=100-this.fuelLevel;
          if (capacity>0.00)
             if (fuelAmount<capacity)
                  this.fuelLevel=this.fuelLevel+fuelAmount;
             else
                 Syste.out.println("your backet has "+ capacity+" liters." );     
